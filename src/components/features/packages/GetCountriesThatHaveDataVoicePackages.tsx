import { getCountriesThatHaveDataVoicePackages } from "@/services/packages.services";
import StartingPriceCard from "./StartingPriceCard";

async function GetCountriesThatHaveDataVoicePackages() {
...
export default GetCountriesThatHaveDataVoicePackages;
