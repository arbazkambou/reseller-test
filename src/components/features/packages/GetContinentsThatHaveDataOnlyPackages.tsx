import { getContinentsThatHaveDataOnlyPackages } from "@/services/packages.services";
...
async function GetContinentsThatHaveDataOnlyPackages() {
  const continents = await getContinentsThatHaveDataOnlyPackages();
...
export default GetContinentsThatHaveDataOnlyPackages;
